	...
	public JSnmpLabelContainer(String iconText, JTabbedPane tabbedPane) {
		...
		btnNewButton
				.setIcon(new ImageIcon(
						DoP_GUI.class
								.getResource("/net/it_tim/dude_of_ping3/icons/Add_Square.png")));
		...
		button.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				for (Component component : panel.getComponents()) {
					if (component instanceof JSnmpLabel
		...
		button
				.setIcon(new ImageIcon(
						DoP_GUI.class
								.getResource("/net/it_tim/dude_of_ping3/icons/Remove_Square.png")));
